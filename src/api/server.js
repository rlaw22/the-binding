...
async function createServer(options = {}) {
  ...
  const storylineV2Handlers = createStorylineV2Handlers({
  ...
  app.get('/api/storyline-v2/status', storylineV2Handlers.status);
  app.post('/api/storyline-v2/sessions', storylineV2Handlers.start);
