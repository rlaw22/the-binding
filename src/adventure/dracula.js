...
The innkeeper watches you from behind the bar. He looks like a man with something to say, but he is waiting for you to speak first.`,
      content: [
        ...
        { id: 'examine_crucifix', label: 'Examine the brass crucifix', keywords: ['crucifix', 'cross', 'examine', 'inspect', 'hold', 'brass'], outcome: 'positive', coinReward: 11, discovery: 'You lift the brass crucifix into the lamplight. It is old — centuries old — the metal worn smooth by countless fingers. The figure of Christ is nearly featureless now, rubbed down to a suggestion of suffering. As you turn it, the firelight catches the edges and for a moment the shadows it casts look like wings. The innkeeper watches you from the doorway. "For protection," he says quietly. "You will need it where you are going."' },
