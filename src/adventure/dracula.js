...
The innkeeper watches you from behind the bar. He looks like a man with something to say, but he is waiting for you to speak first.`,
      content: [
        { id: 'talk_innkeeper', label: 'Ask the innkeeper about Castle Dracula', keywords: ['innkeeper', 'ask', 'tell', 'dracula', 'castle', 'speak', 'talk'], outcome: 'positive', coinReward: 3, discovery: 'You approach the innkeeper and ask about Castle Dracula. His face drains of color. He glances at the door, then at the old woman in the corner, then back at you. "You are going there?" he whispers. "To his castle?" He leans across the bar, his voice barely audible. "The Count is... not like other men. He has lived in that castle for longer than anyone can remember. The people in the mountains — they say he is the reason wolves obey. They say the dead do not rest easy in his land." He grips your wrist with surprising strength. "Take the crucifix. Take it and do not let go. And whatever you do — do not eat his food. Do not drink his wine. And do not fall asleep in his house."' },
        { id: 'examine_crucifix', label: 'Examine the brass crucifix', keywords: ['crucifix', 'cross', 'examine', 'inspect', 'hold', 'brass'], outcome: 'positive', coinReward: 11, itemGained: 'crucifix', discovery: 'You lift the brass crucifix into the lamplight. It is old — centuries old — the metal worn smooth by countless fingers. The figure of Christ is nearly featureless now, rubbed down to a suggestion of suffering. As you turn it, the firelight catches the edges and for a moment the shadows it casts look like wings. The innkeeper watches you from the doorway. "For protection," he says quietly. "You will need it where you are going."' },
        { id: 'find_old_woman', label: 'Approach the old woman in the corner', keywords: ['approach', 'woman', 'corner', 'old', 'talk', 'speak'], outcome: 'positive', coinReward: 7, itemGained: 'garlic', discovery: 'You approach the old woman slowly. Her eyes snap up — sharp, knowing, afraid. She whispers something you can\'t hear, then looks away quickly. Her hands tremble around her cup.' },
        { id: 'check_stables', label: 'Look out the back window at the stable yard', keywords: ['stable', 'stables', 'window', 'coach', 'horse', 'yard', 'outside', 'back'], outcome: 'negative', discovery: 'You peer through the back window. The stable yard is nearly empty — just one horse, stamping and wild-eyed, its coat dark with sweat. The harness hangs loose. No coach. No driver. The animal looks at you with an intelligence that makes your skin crawl. Somewhere in the building behind you, a door slams.' },
        { id: 'read_letter', label: 'Search the bench near the fireplace where the shawl lies', keywords: ['search', 'bench', 'benches', 'fire', 'shawl', 'letter', 'hidden', 'under', 'near'], outcome: 'positive', coinReward: 7, discovery: 'You lift the folded shawl on the bench near the fire. Beneath it, a letter. The handwriting is hurried, desperate: "To whoever finds this — do NOT travel to the Borgo Pass after dark. The wolves are not natural. The coachman is not what he seems. God have mercy on Jonathan Harker\'s soul." The letter is dated three months ago. The ink is smeared, as if the writer\'s hands were shaking.' },
        { id: 'look_around', label: 'Take a careful look around the inn', keywords: ['look', 'around', 'room', 'inn', 'examine', 'survey', 'explore'], outcome: 'mixed', coinReward: 5, discovery: 'You take a moment to survey the inn properly. The fireplace crackles, throwing dancing shadows across rough-hewn walls stained with decades of smoke. The benches are worn smooth by countless travelers. The bar is sticky with spilled ale. The ceiling beams are dark with age. It is warm, it is sheltered, and it is the last friendly place you will see for a very long time. Outside, the wind picks up. You hear the creak of wooden wheels on cobblestones.' },
        // Atmospheric items (reference objects in the scene narrative)
        { id: 'search_mantel', label: 'Search the fireplace mantel', keywords: ['search', 'mantel', 'fireplace', 'mantle'], outcome: 'empty', coinReward: 2, discovery: 'You run your fingers along the rough stone mantel. Nothing hidden — just decades of soot and candle wax. But you notice deep scratches in the stone, as if someone once gripped the edge hard enough to leave marks. Fingernail gouges. Whoever held on here was afraid.' },
        { id: 'examine_beams', label: 'Study the dark ceiling beams', keywords: ['study', 'ceiling', 'beams', 'rafters', 'above', 'dark'], outcome: 'empty', coinReward: 1, discovery: 'You peer up at the ceiling beams. They are ancient oak, blackened by centuries of smoke. Carved into the nearest beam — barely visible — you make out a date: 1642. Below it, someone has scratched a crude cross. A ward against evil, perhaps. It did not work.' },
      ],
      storyMode: {
        badChoice: {
          id: 'drink_ale',
...
You check your pockets. Something warm and hard rests against your thigh — the brass crucifix from the inn. You don't remember putting it there.`,
      content: [
        { id: 'talk_driver', label: 'Try to speak with the silent coachman', keywords: ['driver', 'coachman', 'speak', 'talk', 'silent', 'address'], outcome: 'negative', discovery: 'You lean forward and speak to the driver through the small window. He does not turn. Does not acknowledge you. But you notice his hands on the reins — they are too pale, too steady, and the fingers are longer than they should be. He grips the leather with a gentleness that is almost tender. The priest grabs your arm and pulls you back. \"Do not speak to him,\" he hisses. \"He is not — \" He stops himself. Shakes his head. Returns to his prayers.' },
        { id: 'watch_landscape', label: 'Watch the dark forest pass by the window', keywords: ['forest', 'window', 'outside', 'look', 'watch', 'trees', 'landscape'], outcome: 'mixed', coinReward: 4, discovery: 'You press your face to the narrow window. The Carpathian forest is a blur of black shapes — twisted trees with branches like grasping fingers, jagged rocks that loom and vanish. Occasionally, you catch the gleam of eyes reflecting the coach lantern. Not one pair. Dozens. All watching.' },
        { id: 'notice_wolves', label: 'Listen to the wolves howling in the distance', keywords: ['wolf', 'wolves', 'howl', 'hear', 'listen', 'distant'], outcome: 'positive', coinReward: 7, discovery: 'You press your ear to the window and listen. The wolves are closer than you thought — not in the distance, but running alongside the coach, just beyond the lantern light. Their howls are not random. They rise and fall in patterns, almost like speech. One wolf runs directly beneath your window for a moment, and you see its eyes — not yellow like an animal\'s, but a deep, burning red. The innkeeper was right. These are not natural wolves.' },
        { id: 'examine_crucifix_coach', label: 'Clutch the crucifix for comfort', keywords: ['crucifix', 'cross', 'hold', 'clutch', 'comfort', 'pray'], outcome: 'positive', coinReward: 7, discovery: 'You reach into your pocket and close your fingers around the brass crucifix. It is warm — warmer than it should be, as if it has been sitting in sunlight. As your hand tightens around it, the wolves outside fall silent for a moment, and the coach seems to slow. The priest notices. His eyes widen. \"Where did you get that?\" he whispers. You tell him the innkeeper gave it to you. He nods slowly. \"Keep it close. Do not let go. Not for any reason.\"' },
        // NEW: atmospheric/empty items
        { id: 'check_floor', label: 'Search the floor of the coach for anything left behind', keywords: ['search', 'floor', 'coach', 'beneath', 'seat', 'under'], outcome: 'empty', discovery: null },
        { id: 'study_passengers', label: 'Study the other passengers in silence', keywords: ['study', 'passengers', 'other', 'watch', 'observe', 'silent'], outcome: 'empty', discovery: null }
      ],
      storyMode: {
        badChoice: {
          id: 'open_window',
          label: 'Open the coach window to get fresh air',
          consequence: 'You slide the window open an inch. The night air rushes in \u2014 freezing, sharp, carrying the stench of wet fur and something worse, something ancient and rotten. A grey shape flashes past the opening, so close you feel the brush of coarse hair against your hand. The window slams shut on its own. Your hand is scratched \u2014 three parallel lines, thin as wire, beading with blood. The priest crosses himself and does not look at you.',
          coinCost: 4,
          flagSet: { scratched_by_wolf: true }
        }
      },
...
The road climbs higher. The air grows colder. Through the mist ahead, something vast and dark perches on a cliff — a shape that might be a castle, or might be a trick of the shadows.`,
      content: [
        { id: 'observe_coachman', label: 'Study the mysterious new coachman', keywords: ['coachman', 'driver', 'new', 'study', 'watch', 'observe', 'mysterious'], outcome: 'negative', discovery: 'You lean forward to study the new coachman more closely. Beneath the wide brim of his hat, you catch a glimpse of his profile \u2014 sharp, aristocratic, pale as bone. His hands on the reins are perfectly still, yet the horses respond to his will alone. When lightning flashes, his eyes catch the light \u2014 not reflecting it, but burning with their own dark fire. He knows you are watching. The corner of his mouth twitches. Almost a smile. Almost a challenge.' },
        { id: 'watch_wolves', label: 'Watch the wolves that follow the coach', keywords: ['wolf', 'wolves', 'follow', 'surround', 'watch', 'grey'], outcome: 'mixed', coinReward: 4, discovery: 'They run alongside the coach in perfect silence — great grey shapes flowing between the trees like smoke. Their eyes catch the lantern light and burn yellow. They do not howl. They do not scatter. They pace the coach like an honour guard, and when the driver cracks his whip, they only run faster.' },
        { id: 'feel_speed', label: 'Grip the seat as the coach races through the dark', keywords: ['fast', 'speed', 'race', 'grip', 'seat', 'racing'], outcome: 'negative', discovery: 'The coach lurches and sways, wheels bouncing over roots and stones. You grip the leather strap as the forest becomes a dark smear. The speed is impossible — no horse could maintain this pace uphill, on these roads. And yet the coach accelerates. The driver above you laughs, and the sound is not quite human.' },
        { id: 'notice_eyes', label: 'Peer into the forest and see pairs of glowing eyes', keywords: ['eyes', 'forest', 'glow', 'peer', 'glowing', 'pairs'], outcome: 'positive', coinReward: 5, discovery: 'You press your face to the glass and peer into the blackness between the trees. At first you see nothing. Then your eyes adjust, and the forest comes alive with points of red light \u2014 dozens of pairs of eyes, all watching the coach, all moving in perfect unison. They do not scatter. They do not hunt. They escort. As if they were summoned. As if they were commanded.' },
              // NEW: atmospheric/empty items
        { id: 'check_garlic', label: 'Examine the garlic the priest gave you', keywords: ['garlic', 'examine', 'check', 'priest', 'gave', 'bundle'], outcome: 'empty', discovery: null },
        { id: 'peer_roof', label: 'Peer up through the coach roof at the sky', keywords: ['peer', 'roof', 'sky', 'up', 'stars', 'above'], outcome: 'empty', discovery: null }
      ],
      storyMode: {
        badChoice: {
          id: 'lean_out',
          label: 'Lean out of the coach to see the castle',
          consequence: 'You push your head through the window and look up. The castle is there \u2014 impossibly close, impossibly vast, its black walls blotting out the stars. For a moment you cannot breathe. The coachman\'s hand lands on your shoulder \u2014 cold as a corpse, strong as iron. He pushes you back inside without turning around. When you look at your shoulder, the fabric of your coat is frozen stiff. Ice crystals glitter in the lamplight.',
          coinCost: 3,
          flagSet: { touched_by_coachman: true }
        }
      },
...
The Count leans forward, his dark eyes glittering. "Tell me about England," he says. "I am planning a journey there — a permanent one, in fact. I have already purchased property. Carfax Abbey, it is called. Do you know it?" His smile is warm, curious, patient. He has all the time in the world.`,
      content: [
        { id: 'ask_about_england', label: 'Ask the Count about his interest in England', keywords: ['england', 'ask', 'interest', 'count', 'why'], outcome: 'positive', coinReward: 10, discovery: 'You ask the Count about England. His eyes light up — genuinely, hungrily — and he leans forward as if you have touched upon his favourite subject. "England!" he breathes. "The centre of the modern world. I have studied your language, your customs, your laws. I have already purchased property — Carfax Abbey, near London. A magnificent ruin, perfect for a man of my... antiquarian tastes." He speaks of England the way a predator speaks of a hunting ground. He knows the streets of London, the tides of the Thames, the habits of the English people. He has been planning this for years. Decades, perhaps. His fascination is not academic. It is territorial.' },
        { id: 'notice_no_food', label: 'Notice that no food is set before you', keywords: ['food', 'plate', 'meal', 'notice', 'empty', 'eat'], outcome: 'positive', coinReward: 7, discovery: 'You look at your plate. Empty. You look at the Count\'s plate. Also empty. But his lips are stained with something dark \u2014 not wine, something deeper, more vivid. He catches you staring and touches his mouth with a napkin. "A sauce from my homeland," he says smoothly. "An acquired taste." There is no food anywhere in this room. No kitchen door. No servants. No smell of cooking. Only the wine, and the Count\'s red, red lips.' },
        { id: 'compliment_wine', label: 'Sip the deep red wine and compliment it', keywords: ['wine', 'drink', 'sip', 'compliment', 'red', 'taste'], outcome: 'mixed', coinReward: 5, discovery: 'You raise the glass. The wine is extraordinary — thick, velvety, with a sweetness that clings to your tongue and a warmth that spreads through your chest like swallowed sunlight. "A remarkable vintage," you say. The Count smiles. It is the first genuine smile you have seen from him — wide, almost joyful, showing teeth that are very white and very sharp. "I am glad it pleases you," he says. "It is from my own vineyards. A very old recipe." He watches you drink with an intensity that has nothing to do with the wine. His fingers drum softly on the table. His lips are very red. You set the glass down and notice the Count has not touched his own. His plate remains empty. His glass is full. He has been watching you the entire time.' },
        { id: 'test_dracula', label: 'Mention local legends and watch his reaction', keywords: ['legend', 'local', 'mention', 'watch', 'reaction', 'test'], outcome: 'positive', coinReward: 8, discovery: 'You mention the local legends carefully \u2014 the strigoi, the moroi, the living dead that walk the mountain passes. The Count listens with his head tilted, like a bird watching a worm. When you mention the word \"vampire,\" his smile does not waver. His hand does not tighten on the glass. He simply nods. \"Every culture has its monsters,\" he says. \"In England, I believe yours is the werewolf. The vampire is ours.\" He leans closer. \"But tell me \u2014 have you ever wondered what it would be like to live forever? To see empires rise and fall? To never age, never tire, never die?\" His eyes hold yours. The question is not rhetorical. He genuinely wants your answer.' },
              // NEW: atmospheric/empty items
        { id: 'examine_tapestries', label: 'Study the battle tapestries on the walls', keywords: ['tapestry', 'tapestries', 'walls', 'battle', 'study', 'examine', 'hung'], outcome: 'empty', discovery: null },
        { id: 'test_chair', label: 'Test the floor beneath your chair for drafts', keywords: ['test', 'floor', 'chair', 'draft', 'cold', 'beneath'], outcome: 'empty', discovery: null }
      ],
      storyMode: {
        badChoice: {
          id: 'drink_wine',
          label: 'Finish the glass of deep red wine',
          consequence: 'You drain the glass. The wine is extraordinary \u2014 sweet, thick, warming. Too warming. It spreads through your chest like liquid fire, then crawls up your neck and into your skull. Your vision swims. The Count\'s face blurs, then sharpens \u2014 and for a moment, just a moment, you see him as he truly is: pale as bone, eyes burning red, lips stained with something that is not wine. Then the vision passes and he is just an old man smiling at you across a table. But your crucifix is burning hot against your chest. And you cannot remember the last few minutes.',
          coinCost: 5,
          flagSet: { drank_draculas_wine: true }
        }
      },
