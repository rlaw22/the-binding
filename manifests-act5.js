    ...
    "content": [
      {
        ...
        "keywords": [
          ...
          "bond",
          "ask"
        ], "outcome": "positive", "discovery": "Mina closes her eyes and sways. 'He is... angry. Terrified. He knows we are coming. The box — his coffin — is surrounded by earth from home. He has not left it since he boarded. But the crew...' Her eyes snap open, wet with tears. 'The crew is dying. One by one. He feeds and throws them overboard. The captain does not know what is happening. In four days, five at most, the ship will reach Varna. If we leave now, we can beat him there — or intercept him at the port.' She grips your arm. 'He is weakening me. Every time he feeds, I feel it too. We must hurry.'"
      },
      {
        "id": "talk_strategy",
    ...
    "content": [
      ...
      },
      {
        ...
        "keywords": [
          ...
          "flask",
          "water"
        ], "outcome": "positive", "discovery": "You uncap the flask and hurl its contents at the nearest cluster of Szgany. The holy water catches one full in the face. He screams — not because it burns him, but because the splash hits the amulet around his neck, a twisted thing of bone and iron, and the amulet shatters. The gypsy drops to his knees, clutching his chest. His companions hesitate. In that hesitation, Godalming fires his revolver into the air. The Szgany scatter like startled crows, melting back into the rocks, their war cries fading to whispers on the wind."
      },
      {
        "id": "find_cover",
      ...
      },
      {
        ...
        "keywords": [
          ...
          "examine",
          "find"
        ], "outcome": "positive", "discovery": "You kneel beside the fallen gypsy with the shattered amulet. He is alive — unconscious, breathing shallowly. In his belt pouch, you find a crude map drawn on leather: the path to the castle, marked with symbols — wolves at the forest edge, crosses at the bridge, a skull at the castle gate. And a note in broken English: 'Master comes by the old road. Keep the hunters from the mountain. Fail and die.' Dracula sent them. He knows you are close."
      },
      {
        "id": "encourage_mina",
...
{
        "id": "examine_river_map",
        "label": "Study the river map on the wall",
        "keywords": [
                "examine",
                "river",
                "map",
    ...
    "content": [
      ...
      },
      {
        ...
        "keywords": [
          ...
          "recent",
          "examine"
        ], "outcome": "positive", "discovery": "Among the bones and dead leaves, you find fresh tracks — bare feet, narrow, elongated, pressed deep into the mud. Three sets, all women's. The sisters have been pacing the courtyard. In the fountain's basin, beneath the black residue, you find a woman's ring — gold, set with a ruby. Engraved inside: L.W. Lucy Westenra. Your stomach turns. She wore this in her coffin. Someone has brought it here."
      },
      {
        "id": "listen_to_castle",
    ...
    "content": [
      {
        ...
        "keywords": [
          ...
          "first",
          "flask"
        ], "outcome": "positive", "discovery": "You hurl the flask of holy water and it strikes the eldest sister full in the chest. The effect is volcanic. She screams — a sound that cracks the window glass and sends the bats scattering in panic. Where the holy water touches her, her flesh boils and peels, revealing something ancient and black beneath. She staggers back, clawing at herself, her beauty dissolving like wax held to flame. 'Impossible,' she hisses. 'You have no power here.' But the burns spread, smoking, and she falls to one knee."
      },
      {
        "id": "thrust_crucifix",
        ...
        "keywords": [
          ...
          "cross",
          "ward"
        ], "outcome": "positive", "discovery": "You raise the crucifix and step forward. The light blazes — white, searing, casting shadows that are wrong because they point toward the vampires, not away from the light source. The second sister and the third recoil, hissing, their arms raised to shield their faces. The eldest, already burning, screeches and throws herself backward through the air, landing on the far wall like a spider. 'Kill the one holding it!' she screams. 'Kill the mortal! The Master demands it!'"
      },
      {
        "id": "drive_stake",
...
{
        "id": "examine_old_walls",
        "label": "Examine the old walls for hidden entrances",
        "keywords": [
                "examine",
                "old",
                "walls",
    ...
    "content": [
      ...
      },
      {
        ...
        "keywords": [
          ...
          "strength",
          "resist"
        ], "outcome": "positive", "discovery": "'Mina!' you shout. Her eyes snap open. They are red — Dracula's red — and for a terrible moment you think she is lost. Then she blinks. The red fades. Her own eyes return — brown, fierce, burning with a will that has endured months of darkness and hunger and the constant whisper of the dead in her blood. She holds the wooden cross to her chest. 'No,' she says. The word is quiet but it fills the crypt. 'I am not yours. I was never yours.' Dracula turns to face her. 'You are mine. You have tasted of my blood —' 'And I reject it,' she says. 'I reject you. I reject the darkness. I choose the dawn.' The scar on her forehead blazes white — not red, white — and a crack appears in the air between them. The blood bond shatters like glass. Dracula staggers as if struck by a physical blow. For the first time in five hundred years, he is alone."
      },
      {
    ...
    ,
{
    ...
    "storyMode": {
      ...
      "explorePriority": [
        "drive_final_stake",
        "hold_crucifix_forward",
        "use_remaining_holy_water"
      ]
    }
  }
};
