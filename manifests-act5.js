module.exports = {
  "scene_20": {
    ...
    "storyMode": {
      ...
      "badChoice": {
        "id": "touch_artifact",
        "label": "Risk taking action: Ask Mina what she senses from Dracula",
  ...
  "scene_21": {
    ...
    "storyMode": {
      ...
      "badChoice": {
        "id": "trust_stranger",
        "label": "Risk taking action: Shield Mina and draw your weapon",
  ...
  "scene_22": {
    ...
    "storyMode": {
      ...
      "badChoice": {
        "id": "explore_alone",
        "label": "Risk taking action: Push open the castle door and step inside",
  ...
  "scene_23": {
    ...
    "storyMode": {
      ...
      "badChoice": {
        "id": "drink_offered",
        "label": "Risk taking action: Throw holy water at the eldest sister",
  ...
  "scene_24": {
    ...
    "storyMode": {
      ...
      "badChoice": {
        "id": "open_coffin",
        "label": "Risk taking action: Rush Dracula with the oak stake and hammer",
