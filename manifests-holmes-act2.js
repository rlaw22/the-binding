module.exports = {
  "scene_05": {
    ...
    "initialFacts": {
      ...
      "established": [
        ...
        "the Hall is ancient and imposing",
        "portraits line the walls",
        "Mrs. Barrymore has been weeping",
        "Hugo Baskerville portrait resembles someone"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "badChoice": {
        ...
        "label": "Risk taking action: Study the portraits of the Baskerville family",
  ...
  "scene_06": {
    ...
    "initialFacts": {
      ...
      "established": [
        "Mrs. Barrymore weeps at night",
        "Barrymore signals to someone on the moor with a candle",
        "someone answers from the darkness",
        "the Barrymores are hiding something"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "badChoice": {
        "id": "confront_alone",
        "label": "Risk taking action: Watch Barrymore signal from the window",
  ...
  "scene_07": {
    ...
    "initialFacts": {
      ...
      "metNPCs": [],
      "established": [
        "heard a terrible howl on the moor at night",
        "the sound was not a natural animal",
        "enormous paw prints in the peat",
        "something is moving on the moor near the Hall"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "badChoice": {
        "id": "dismiss_witness",
        "label": "Risk taking action: Stand still and listen to the howl",
  ...
  "scene_08": {
    ...
    "initialFacts": {
      ...
      "established": [
        "met Jack Stapleton, naturalist neighbour",
        "met Beryl Stapleton (his sister)",
        "Beryl warned to leave the moor",
        "Stapleton resembles Hugo Baskerville portrait",
    ...
    "storyMode": {
      ...
      "badChoice": {
        "id": "reveal_clue",
        "label": "Risk taking action: Speak with Stapleton about the moor",
  ...
  "scene_09": {
    ...
    "initialFacts": {
      ...
      "established": [
        "Selden the convict is on the moor",
        "Barrymore signals to Selden",
        "Mrs. Barrymore is Selden's sister",
        "Selden is terrified of something on the moor",
        "enormous paw prints near Selden's camp"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "badChoice": {
        "id": "ignore_watson",
        "label": "Risk taking action: Chase Selden across the moor",
