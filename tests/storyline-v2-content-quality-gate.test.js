...
function base(overrides = {}) {
  return { schemaVersion:'2.0', adventureId:'book-test', title:'Book', source:{generation:'whole-book-ingestion'}, scenes:[{
    sceneId:'s1', name:'The Inn', setting:'A crowded inn at dusk.', openingNarration:'Rain lashes the windows as the traveller reaches the inn. A frightened host bars the door, and footsteps approach from the road.', actions:[
      {actionId:'look', type:'exploration', role:'discovery', replay:'repeatable', label:'Inspect the barred door', shortLabel:'Inspect the door', resolution:{narration:'You inspect the barred door and find fresh scratches in the wood.'}},
      {actionId:'leave', type:'exit', role:'commitment', replay:'consumable', label:'Leave before the footsteps arrive', shortLabel:'Leave now', resolution:{narration:'You leave before the footsteps arrive.'}}
    ]
