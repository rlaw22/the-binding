module.exports = {
  "scene_05": {
    ...
    "sceneName": "The Animation",
        "presentCharacters": ["victor frankenstein","professor krempe"],
    ...
    "initialFacts": {
      ...
      "established": [
        "laboratory is ready",
        "creature is assembled",
        "voltaic apparatus is charged",
        "Victor is alone"
      ]
    },
    "locationKeywords": {
    ...
    "storyMode": {
      ...
      "isHealing": false,
      "explorePriority": [
        "examine_living_creature",
        "back_away_from_creature",
        "listen_to_creature_breathing"
      ],
      "threat": "fr_creation_2"
    }
  },
  "scene_06": {
    "sceneId": "scene_06",
    "sceneName": "The Creature's First Moments",
        "presentCharacters": ["victor frankenstein","professor waldman"],
    ...
    "initialFacts": {
      ...
      "established": [
        "creature is alive",
        "creature is afraid",
        "creature reaches for Victor",
        "Victor has fled the laboratory"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "threat": "fr_creation_3"
    }
  },
  "scene_07": {
    "sceneId": "scene_07",
    "sceneName": "Victor's Collapse",
        "presentCharacters": ["victor frankenstein"],
    ...
    "initialFacts": {
      ...
      "established": [
        "Victor has fled the laboratory",
        "creature is alive and abandoned",
        "Clerval has found Victor",
        "Victor is collapsing from guilt and exhaustion"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "work_without_sleep",
            "label": "Work for seven days without sleep",
            "consequence": "Your vision blurs. The instruments shake in your hands. You complete the work — but your judgment is gone. Details you should have caught go unnoticed.",
            "coinCost": 4,
            "flagSet": {
                  "sleepless_work": true
            }
  ...
  "scene_08": {
    ...
    "initialFacts": {
      ...
      "established": [
        ...
        "Victor has recovered from fever",
        "creature has escaped the laboratory",
        "creature is somewhere in Ingolstadt",
        "Victor has not told anyone the truth"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "flee_the_creation",
            "label": "Flee the apartment the moment the creature moves",
            "consequence": "You run into the rain. Behind you, a hand reaches out from the table — and finds nothing. The creature is alone, confused, newborn. You have already failed it.",
            "coinCost": 4,
            "flagSet": {
  ...
  "scene_09": {
    ...
    "initialFacts": {
      ...
      "established": [
        "William is dead",
        "Justine is accused of the murder",
        "Victor knows the creature killed William",
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "burn_the_notes",
            "label": "Burn all your laboratory notes",
            "consequence": "The flames consume years of work. Without the notes, you can never understand what went wrong — or how to fix it.",
            "coinCost": 3,
            "flagSet": {
                  "destroyed_evidence": true
            }
      },
      "isHealing": false,
      "explorePriority": [
