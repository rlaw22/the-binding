module.exports = {
  "scene_15": {
    ...
    "sceneName": "The Creature's Demand",
        "presentCharacters": ["the creature","felix de lacey","safie"],
    ...
    "initialFacts": {
      ...
      "established": [
        ...
        "creature demands a female companion",
        "creature threatens revenge if refused",
        "creature has told his story",
        "Victor is terrified for Elizabeth"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "reveal_creature_to_felix",
            "label": "Reveal the creature's existence to Felix",
            "consequence": "Felix attacks the creature with a fire poker. Safie screams. The family flees in terror. The creature stands alone in the ruins of its only kindness.",
            "coinCost": 4,
            "flagSet": {
                  "triggered_violence": true
            }
      },
      "isHealing": false,
      "explorePriority": [
      ...
      "threat": "fr_confrontation"
    }
  },
  "scene_16": {
    "sceneId": "scene_16",
    "sceneName": "The Orkney Workshop",
        "presentCharacters": ["the creature","de lacey (old man)"],
    ...
    "initialFacts": {
      ...
      "established": [
        "Victor is on a remote Scottish island",
        "Victor is creating a female creature",
        "the creature watches from a distance",
        "Victor is wracked with doubt",
        "the female creature is half-finished",
        "the voltaic apparatus is set up in the workshop"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "betray_de_lacey",
            "label": "Tell the creature where the De Laceys fled",
            "consequence": "The creature finds them. What happens next you learn only from the newspapers. Three dead. No survivors. Your hands are not clean.",
            "coinCost": 5,
            "flagSet": {
                  "caused_deaths": true
            }
  ...
  "scene_17": {
    ...
    "sceneName": "The Destruction",
        "presentCharacters": ["the creature","felix de lacey"],
    ...
    "initialFacts": {
      ...
      "established": [
        "Victor has destroyed the female creature",
        "the creature witnessed the destruction",
        "the creature has threatened revenge on Victor's wedding night",
        "Victor is consumed by guilt and fear"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      "collectibleItem": {
        "id": "laboratory_key",
        "label": "Laboratory Key"
      },
      "badChoice": {
            "id": "offer_false_promise",
            "label": "Promise to make the creature a companion — then plan to destroy it",
            "consequence": "The creature sees the lie in your eyes. \"I will know if you betray me,\" it says. Its voice is soft, but the threat is absolute.",
            "coinCost": 4,
            "flagSet": {
                  "lied_to_creature": true
            }
      },
      "isHealing": false,
      "explorePriority": [
        "destroy_female",
        "look_at_creature_reaction",
        "burn_remains"
      ]
    }
  },
  "scene_18": {
    ...
    "sceneName": "The Creature's Revenge",
        "presentCharacters": ["the creature"],
    ...
    "initialFacts": {
      ...
      "established": [
        "Clerval is dead",
        "the creature murdered Clerval",
        "Victor has been found unconscious beside the body",
        "Victor is accused of the murder",
        "Victor is imprisoned in Ireland"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "steal_body_parts",
            "label": "Steal parts from the charnel house at night",
            "consequence": "The work is sickening. Your hands shake. The parts are wrong — mismatched, decayed. Whatever you build will suffer from the start.",
            "coinCost": 4,
            "flagSet": {
                  "corrupted_work": true
            }
  ...
  "scene_19": {
    ...
    "sceneName": "Elizabeth's Last Letter",
        "presentCharacters": ["victor frankenstein","the creature"],
    ...
    "initialFacts": {
      ...
      "established": [
        "Victor has been acquitted of Clerval's murder",
        "Victor is in Paris recovering",
        "the wedding to Elizabeth is arranged",
        "Victor knows the creature will come on his wedding night",
        "Victor has written a confession letter",
        "Victor is returning to Geneva"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "destroy_half_finished",
            "label": "Destroy the half-finished female creature in front of the male",
            "consequence": "The creature watches, silent. When the last piece is torn apart, it speaks: \"You have chosen your path. I will choose mine.\" It disappears. The killing resumes.",
            "coinCost": 5,
            "flagSet": {
