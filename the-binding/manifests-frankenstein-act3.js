module.exports = {
  "scene_10": {
    ...
    "sceneName": "The Forest Awakening",
        "presentCharacters": ["victor frankenstein","henry clerval"],
    ...
    "initialFacts": {
      ...
      "established": [
        "creature is alone in the forest",
        "creature can see its reflection",
        "creature is drawn to human warmth",
        "creature does not yet understand language"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "tell_clerval_nothing",
            "label": "Tell Clerval nothing of what you created",
            "consequence": "Clerval nurses you through your fever, never knowing the truth. The secret festers between you, invisible and corrosive.",
            "coinCost": 3,
            "flagSet": {
                  "kept_secret": true
            }
  ...
  "scene_11": {
    ...
    "sceneName": "The De Lacey Cottage",
        "presentCharacters": ["victor frankenstein","alphonse frankenstein"],
    ...
    "initialFacts": {
      ...
      "established": [
        "creature lives in lean-to beside the cottage",
        "creature has learned language by listening",
        "creature reads the family's books",
        "creature leaves gifts for the family",
        "creature plans to approach the blind old man",
        "De Lacey family (Felix, Agatha, old man, Safie) observed through the wall but not yet met"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "blame_alphonse",
            "label": "Blame your father for not stopping you",
            "consequence": "\"I trusted you,\" Alphonse says quietly. The disappointment in his voice is worse than any accusation. You have wounded the one person who never doubted you.",
            "coinCost": 3,
            "flagSet": {
                  "blamed_father": true
            }
  ...
  "scene_12": {
    ...
    "sceneName": "The Old Man's Kindness",
        "presentCharacters": ["victor frankenstein","justine moritz"],
    ...
    "initialFacts": {
      ...
      "established": [
        "creature spoke with the blind old man",
        "old man accepted the creature as a friend",
        "old man is blind and cannot see the creature",
        "family is returning from the market",
        "the creature has read Paradise Lost, Plutarch's Lives, and The Sorrows of Young Werther"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      "collectibleItem": {
        "id": "letter_from_victor",
        "label": "Victor's Letter"
      },
      "badChoice": {
            "id": "abandon_justine",
            "label": "Abandon Justine to her fate",
            "consequence": "You say nothing at the trial. Justine is convicted. She looks at you once — confused, betrayed — and is led away. The creature watches from the shadows, satisfied.",
            "coinCost": 4,
            "flagSet": {
                  "let_justine_die": true
            }
      },
      "isHealing": true,
      "explorePriority": [
  ...
  "scene_13": {
    ...
    "initialFacts": {
      ...
      "established": [
        ...
        "creature did not fight back",
        "family has rejected the creature",
        "creature is devastated",
        "creature will seek its creator",
        "the creature has read Paradise Lost, Plutarch's Lives, and The Sorrows of Young Werther"
      ]
    },
    "locationKeywords": {
    ...
    "storyMode": {
      "collectibleItem": {
        "id": "clerval_journal",
        "label": "Clerval's Journal"
      },
      "badChoice": {
            "id": "refuse_to_listen",
            "label": "Refuse to listen to the creature's story",
            "consequence": "\"You will not hear me?\" the creature says. Its voice breaks. \"Then I will make you listen.\" It vanishes into the night, and the killing begins.",
            "coinCost": 4,
            "flagSet": {
                  "refused_creature": true
            }
      },
      "isHealing": false,
      "explorePriority": [
  ...
  "scene_14": {
    ...
    "sceneName": "The Creature's Resolve",
        "presentCharacters": ["the creature","de lacey (old man)","felix de lacey","agatha de lacey"],
    ...
    "initialFacts": {
      ...
      "established": [
        ...
        "creature is traveling to find its creator",
        "creature has learned language, reading, and human customs",
        "creature plans to demand a companion",
        "creature is becoming bitter and desperate",
        "the creature has read Plutarch's Lives and The Sorrows of Young Werther"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "spy_on_de_lacey",
            "label": "Spy on the De Lacey family for the creature",
            "consequence": "You are seen. Felix chases you from the garden, shouting. The creature's only hope of companionship is shattered by your clumsiness.",
            "coinCost": 3,
            "flagSet": {
                  "exposed_spy": true
            }
