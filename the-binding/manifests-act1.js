module.exports = {
  "scene_00": {
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "burn_the_letter",
            "label": "Burn the letter and refuse the commission",
            "consequence": "Mr. Hawkins is gravely disappointed. The Count will find another solicitor — and you will never know what darkness you escaped.",
            "coinCost": 3,
            "flagSet": {
                  "refused_commission": true
            }
      },
      "isHealing": false,
      "explorePriority": [
  ...
  "scene_01": {
    ...
    "sceneName": "The Journey East",
        "presentCharacters": ["jonathan harker","innkeeper"],
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "leave_the_train",
            "label": "Leave the train at Vienna and turn back",
            "consequence": "You abandon the journey. The innkeeper at Bistritz waits in vain. The Count sends a cold letter to Mr. Hawkins, and your career suffers.",
            "coinCost": 3,
            "flagSet": {
                  "abandoned_journey": true
            }
      },
      "isHealing": false,
      "explorePriority": [
  ...
  "scene_02": {
    ...
    "sceneName": "Borgo Pass",
        "presentCharacters": ["jonathan harker","mysterious coachman"],
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "run_from_wolves",
            "label": "Leap from the carriage and run into the forest",
            "consequence": "The wolves close in. The coachman's whip cracks, but the darkness swallows you whole.",
            "coinCost": 4,
            "flagSet": {
                  "lost_in_forest": true
            }
  ...
  "scene_03": {
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "shout_at_driver",
            "label": "Shout at the mysterious driver to stop",
            "consequence": "The driver turns — his eyes burn red in the moonlight. The horses bolt. You are thrown against the seat as the carriage hurtles onward without mercy.",
            "coinCost": 3,
            "flagSet": {
                  "angered_driver": true
            }
  ...
  "scene_04": {
    ...
    "storyMode": {
      ...
      "badChoice": {
            ...
            "consequence": "Dracula's smile fades. \"You are already inside, Mr. Harker.\" The gates slam shut behind you.",
            "coinCost": 4,
            "flagSet": {
                  "trapped_courtyard": true
            }
      },
      "isHealing": false,
      "explorePriority": [
