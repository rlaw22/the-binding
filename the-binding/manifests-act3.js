module.exports = {
  "scene_10": {
    ...
    "content": [
      ...
      {
        "id": "ask_about_allies",
        "label": "Ask if there are others who can help fight Dracula",
        "keywords": [
          "allies",
          "others",
          "help",
  ...
  "scene_11": {
    ...
    "sceneName": "Lucy's Illness",
        "presentCharacters": ["mina","lucy","seward"],
    ...
    "content": [
      ...
      {
        "id": "examine_lucy_close",
        "label": "Gently rouse Lucy from her trance and ask what she remembers",
        "keywords": [
          "wake",
          "rouse",
          "trance",
        ...
        "discovery": "You touch Lucy's shoulder gently. Her eyes snap open — unfocused, glassy, the blue of her irises rimmed with something darker. 'You're here,' she murmurs. 'He said you would come.' She tries to sit up and fails. 'I dreamed of wings,' she whispers. 'Dark wings. And a voice that promised me forever.' Her hand finds yours. Her fingers are ice-cold. 'Don't let him take me,' she says, and then her eyes roll back and she is gone again, sinking into a sleep that looks less like rest and more like surrender."
      }
    ],
    ...
    "storyMode": {
      "collectibleItem": {
        "id": "coat",
        "label": "Heavy Fur Coat"
      },
      "badChoice": {
            "id": "dismiss_lucys_dreams",
            "label": "Dismiss Lucy's sleepwalking as hysteria",
            "consequence": "You do nothing. That night, Lucy walks again. By the time Mina finds her on the cliff path, something has already touched her throat.",
            "coinCost": 3,
            "flagSet": {
                  "ignored_lucy": true
            }
  ...
  "scene_12": {
    ...
    "sceneName": "Renfield's Warning",
        "presentCharacters": ["seward","renfield"],
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "enter_renfields_cell",
            "label": "Enter Renfield's cell without precautions",
            "consequence": "Renfield lunges. His fingers close around your throat with surprising strength. \"He told me you'd come!\" he shrieks. Orderlies drag him off, but your collar is torn and bleeding.",
            "coinCost": 3,
            "flagSet": {
                  "renfield_attack": true
            }
      },
      "isHealing": false,
      "explorePriority": [
        "ask_about_master",
        "ask_about_lucy_renfield",
        "ask_about_weakness"
      ]
    }
  },
  "scene_13": {
    ...
    "sceneName": "The Night Watch",
        "presentCharacters": ["lucy","mina","seward"],
    ...
    "storyMode": {
      "collectibleItem": {
        "id": "map_romania",
        "label": "Map of Romania"
      },
      "badChoice": {
            "id": "ignore_the_bite",
            "label": "Ignore the bite marks on Lucy's neck",
            "consequence": "You tell yourself it is nothing. A rash, perhaps. An allergy. Lucy grows paler each day, and you grow more afraid to look at her throat.",
            "coinCost": 3,
            "flagSet": {
                  "denied_bite": true
            }
  ...
  "scene_14": {
    ...
    "sceneName": "Lucy's Death",
        "presentCharacters": ["seward","van_helsing","lucy"],
    ...
    "storyMode": {
      "collectibleItem": {
        "id": "bellarmines",
        "label": "Earth-filled Bellarmines"
      },
      "badChoice": {
            "id": "reject_van_helsing",
            "label": "Reject Van Helsing's theories as madness",
            "consequence": "\"You are a fool, Doctor,\" Van Helsing says sadly. \"And Lucy will pay for your foolishness.\" He leaves. Lucy's condition worsens overnight.",
            "coinCost": 4,
            "flagSet": {
                  "rejected_helsing": true
            }
      },
      "isHealing": true,
      "explorePriority": [
        "comfort_seward",
        "agree_with_van_helsing",
        "examine_lucy_body"
      ],
      "threat": "dr_storm_landing"
    }
  }
};
