module.exports = {
  "scene_00": {
    ...
    "sceneName": "Geneva — The Frankenstein Home",
        "presentCharacters": ["captain walton"],
    ...
    "initialFacts": {
      ...
      "established": [
        "Victor is a young man in Geneva",
        "family is warm and loving",
        "Victor is fascinated by natural philosophy",
        "a storm is gathering over the lake",
        "Elizabeth is Victor's beloved companion"
      ]
    },
    "locationKeywords": {
      "banned": [
  ...
  "scene_01": {
    ...
    "sceneName": "University of Ingolstadt",
        "presentCharacters": ["captain walton","victor frankenstein"],
    ...
    "initialFacts": {
      ...
      "established": [
        "Victor is at the University of Ingolstadt",
        "Waldman has inspired Victor",
        "Victor is focused on galvanism and the secret of life",
        "Victor has access to anatomy facilities"
      ]
    },
    "locationKeywords": {
      "banned": [
  ...
  "scene_02": {
    ...
    "sceneName": "The Obsession Deepens",
        "presentCharacters": ["victor frankenstein","alphonse frankenstein","caroline frankenstein"],
    ...
    "initialFacts": {
      ...
      "established": [
        "months have passed",
        "Victor is consumed by obsession",
        "Waldman is dead",
        "Victor has not contacted his family",
        "Victor gathers materials from charnel houses and slaughterhouses",
        "the creature is being assembled"
      ]
    },
    "locationKeywords": {
      "banned": [
  ...
  "scene_03": {
    ...
    "sceneName": "The Laboratory",
        "presentCharacters": ["victor frankenstein","elizabeth","alphonse frankenstein"],
    ...
    "initialFacts": {
      ...
      "established": [
        ...
        "Victor is isolated and exhausted",
        "the voltaic apparatus is charged"
      ]
    },
    "locationKeywords": {
      "banned": [
  ...
  "scene_04": {
    ...
    "initialFacts": {
      ...
      "established": [
        ...
        "the creature is on the table",
        "the voltaic apparatus is ready",
        "Victor is alone with his creation",
    ...
    "storyMode": {
      ...
      "explorePriority": [
        "pull_switch",
        "examine_creature_final",
        "hesitate"
      ],
      "threat": "fr_creation_1"
    }
  }
};
