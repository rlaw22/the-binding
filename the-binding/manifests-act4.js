module.exports = {
  "scene_15": {
    ...
    "sceneName": "Finding Mina",
        "presentCharacters": ["mina","jonathan harker"],
    ...
    "content": [
      ...
      {
        "id": "search_outside",
        "label": "Search the street outside for signs of Dracula's presence",
        "keywords": [
          "street",
          "outside",
          "search",
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "read_draculas_journal",
            "label": "Read Jonathan's stolen journal without permission",
            "consequence": "The entries describe horrors beyond imagining — rituals, blood, the living dead. Your hands shake so badly you drop the journal. The ink smears, destroying evidence.",
            "coinCost": 3,
            "flagSet": {
      ...
      "explorePriority": [
        "ask_about_marks",
        "ask_about_dracula_visits",
        "examine_window_and_sill"
      ]
    }
  },
  "scene_16": {
    ...
    "sceneName": "Mina in Danger",
        "presentCharacters": ["lucy","mina","van_helsing"],
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "disturb_the_grave",
            "label": "Dig up Lucy's grave before Van Helsing arrives",
            "consequence": "You strike the coffin lid with a shovel. It splinters. Inside, something moves. You run, leaving the grave open and the shovel behind.",
            "coinCost": 4,
            "flagSet": {
                  "premature_exhumation": true
            }
      },
      "isHealing": false,
      "explorePriority": [
        "examine_mina_condition",
        "ask_van_helsing_ritual",
        "ask_seward_medical"
      ]
    }
  },
  "scene_17": {
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "hesitate_at_window",
            "label": "Hesitate when the dark figure appears at Lucy's window",
            "consequence": "The figure sees you. It turns — its eyes burn like coals. By the time you move, it has dissolved into the night, and Lucy is weaker still.",
            "coinCost": 3,
            "flagSet": {
                  "hesitated_again": true
            }
      },
      "isHealing": false,
      "explorePriority": [
  ...
  "scene_18": {
    ...
    "sceneName": "Dracula's Counter-Attack",
        "presentCharacters": ["mina","dracula"],
    ...
    "storyMode": {
      "collectibleItem": {
        "id": "ancient_key",
        "label": "Ancient Iron Key"
      },
      "badChoice": {
            "id": "open_train_window",
            "label": "Open the train window to get fresh air",
            "consequence": "A gust of freezing wind rushes in. Something dark and swift slips through the gap. You slam the window shut, but Mina gasps — she feels a presence now, watching.",
            "coinCost": 4,
            "flagSet": {
                  "let_dracula_in": true
            }
      ...
      "isHealing": false,
      "explorePriority": [
        "defend_against_wolves",
        "read_dracula_note",
        "search_for_mina_trail"
      ]
    }
  },
  "scene_19": {
    ...
    "sceneName": "The Blood Bond",
        "presentCharacters": ["mina","van_helsing","seward"],
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "doubt_mina",
            "label": "Doubt Mina's account of what she saw",
            "consequence": "\"You don't believe me,\" Mina says, her voice flat. The hurt in her eyes is worse than any monster. You have broken something between you.",
            "coinCost": 3,
            "flagSet": {
                  "mistrusted_mina": true
            }
      },
      "isHealing": false,
      "explorePriority": [
        "take_mina_hand",
        "ask_van_helsing_bond",
        "ask_mina_what_she_feels"
      ]
    }
  }
};
