module.exports = {
  "scene_00": {
    ...
    "sceneName": "221B Baker Street",
        "presentCharacters": ["mortimer","holmes","watson"],
    ...
    "initialFacts": {
      ...
      "established": [
        "Dr. Mortimer has come to consult Holmes",
        "the matter involves the Baskerville family of Dartmoor",
        "Mortimer has brought an old manuscript",
        "the case involves a legend two hundred years old"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "ignore_mortimer",
            "label": "Ignore Dr. Mortimer's strange tale",
            "consequence": "\"A hound from hell,\" Mortimer repeats, desperate. You wave him away. The next morning, Sir Charles Baskerville is found dead on the moor.",
            "coinCost": 3,
            "flagSet": {
                  "ignored_mortimer": true
            }
      },
      "isHealing": false,
      "explorePriority": [
  ...
  "scene_01": {
    ...
    "initialFacts": {
      ...
      "established": [
        "the Baskerville family is cursed by a supernatural hound",
        "Sir Hugo Baskerville died on the moor two hundred years ago",
        "Sir Charles Baskerville died at the gate of the Hall",
        "enormous hound prints were found near Sir Charles's body",
        "Mortimer believes something unnatural is at work"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "refuse_the_case",
            "label": "Refuse to take the Baskerville case",
            "consequence": "Holmes stares at you. \"Then Sir Henry will face it alone.\" You see something in his eyes — not judgment, but a quiet certainty that you will regret this.",
            "coinCost": 3,
            "flagSet": {
                  "refused_case": true
            }
  ...
  "scene_02": {
    ...
    "initialFacts": {
      ...
      "established": [
        "Sir Henry Baskerville has arrived from Canada",
        "he is the sole heir to the Baskerville estate",
        "the estate is worth seven hundred and forty thousand pounds",
        "an anonymous warning letter has been received",
        "the warning was assembled from newspaper cuttings"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      "collectibleItem": {
        "id": "baker_street_note",
        "label": "Baker Street Note"
      },
      "badChoice": {
            "id": "tell_sir_henry_nothing",
            "label": "Tell Sir Henry nothing about the curse",
            "consequence": "Sir Henry arrives in London cheerful and unsuspecting. When the first threat comes, he is unprepared. The shock nearly breaks him.",
            "coinCost": 3,
            "flagSet": {
                  "withheld_info": true
            }
  ...
  "scene_03": {
    ...
    "initialFacts": {
      ...
      "established": [
        "a brown boot has been stolen from Sir Henry's hotel room",
        "only one boot was taken — not a pair",
        "no sign of forced entry",
        "someone with access to the hotel took it",
        "Holmes believes someone is watching Sir Henry closely"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "follow_wrong_lead",
            "label": "Follow the bearded stranger instead of checking the hotel",
            "consequence": "The stranger leads you through three changes of cab and into a dead end. By the time you return, Sir Henry's boot has been stolen from the hotel lobby.",
            "coinCost": 3,
            "flagSet": {
                  "wrong_lead": true
            }
  ...
  "scene_04": {
    ...
    "sceneName": "Departure for Dartmoor",
        "presentCharacters": ["holmes","watson","sir_henry","barrymore","mrs_barrymore"],
    ...
    "initialFacts": {
      ...
      "established": [
        "Holmes is staying in London to investigate the London clues",
        "Watson is going to Dartmoor with Sir Henry",
        "Holmes has instructed Watson to observe everything and write daily",
        "the moor is dangerous at night",
        "the Barrymores are the servants at the Hall",
        "Holmes suspects a human intelligence behind the events"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "accuse_barrymore",
            "label": "Accuse Barrymore of theft without evidence",
            "consequence": "Barrymore's face goes white. \"I have served this family for twenty years,\" he says. Mrs. Barrymore weeps. The staff will not speak to you again.",
            "coinCost": 3,
            "flagSet": {
