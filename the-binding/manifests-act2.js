module.exports = {
  "scene_05": {
    ...
    "sceneName": "The Forbidden Wing",
        "presentCharacters": ["jonathan harker","dracula"],
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "explore_dungeon",
            "label": "Descend into the castle dungeon alone",
            "consequence": "The stairs spiral downward into impenetrable darkness. Something breathes in the black. You stumble back up, shaken, and find Dracula watching you from the top of the stairs.",
            "coinCost": 3,
            "flagSet": {
                  "found_dungeon": true
            }
  ...
  "scene_06": {
    ...
    "storyMode": {
      "collectibleItem": {
        "id": "mirror_shard",
        "label": "Silver Mirror Shard"
      },
      "badChoice": {
            "id": "search_draculas_chamber",
            "label": "Search Dracula's private chamber while he sleeps",
            "consequence": "You find the Count lying in his coffin, eyes open, staring at you. His lips curl into a smile. \"Did you find what you were looking for, Mr. Harker?\"",
            "coinCost": 4,
            "flagSet": {
                  "caught_snooping": true
            }
      },
      "isHealing": false,
      "explorePriority": [
  ...
  "scene_07": {
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "climb_tower_wall",
            "label": "Scale the castle wall using a rope of bedsheets",
            "consequence": "The rope snaps. You fall thirty feet onto the hard flagstones below. Your ankle shatters. Dracula appears above, looking down with something like pity.",
            "coinCost": 5,
            "flagSet": {
                  "broken_ankle": true
            }
  ...
  "scene_08": {
    ...
    "sceneName": "Escape from the Castle",
        "presentCharacters": ["jonathan harker"],
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "open_wrong_door",
            "label": "Open the forbidden door in the east wing",
            "consequence": "Inside, dozens of pale figures lie in wooden boxes. They stir. Their eyes open. You slam the door and hear scratching from the other side.",
            "coinCost": 4,
            "flagSet": {
                  "saw_brides": true
            }
  ...
  "scene_09": {
    ...
    "storyMode": {
      "collectibleItem": {
        "id": "tepid_pass",
        "label": "Tepid Pass Note"
      },
      "badChoice": {
            "id": "attack_dracula",
            "label": "Attack Dracula with a stolen knife",
            "consequence": "The blade passes through him like smoke. He catches your wrist and squeezes until the bone creaks. \"Brave,\" he whispers. \"But foolish.\"",
            "coinCost": 4,
            "flagSet": {
                  "attacked_count": true
            }
