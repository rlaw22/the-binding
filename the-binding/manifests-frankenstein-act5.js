module.exports = {
  "scene_20": {
    ...
    "initialFacts": {
      ...
      "established": [
        "Victor and Elizabeth are married",
        "they are at a villa on Lake Geneva",
        "the creature has come as promised",
        "Victor is armed but outmatched",
  ...
  "scene_21": {
    ...
    "initialFacts": {
      ...
      "established": [
        "Elizabeth is dead",
        "Victor's father is dead",
        "Victor has lost everyone",
        "the creature has fled north",
        "Victor is pursuing the creature",
        "Victor is armed and determined"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "challenge_creature",
            "label": "Challenge the creature to a duel",
            "consequence": "The creature accepts. On the ice field at dawn, you face each other. It is faster, stronger, and tireless. You never had a chance.",
            "coinCost": 5,
            "flagSet": {
                  "lost_duel": true
            }
  ...
  "scene_22": {
    ...
    "sceneName": "The Arctic Waste",
        "presentCharacters": ["victor frankenstein","elizabeth"],
    ...
    "initialFacts": {
      ...
      "established": [
        "Victor is in the Arctic",
        "his dogs are dead",
        "he is alone on the ice",
        "the creature is ahead, leaving signs",
        "Victor is suffering from frostbite and exhaustion",
        "the creature is leading him northwest"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      "collectibleItem": {
        "id": "marriage_medallion",
        "label": "Marriage Medallion"
      },
      "badChoice": {
            "id": "refuse_wedding",
            "label": "Refuse to marry Elizabeth",
            "consequence": "\"If not now, when?\" Elizabeth asks. Her eyes search yours. You see the hurt, the doubt, the slow erosion of trust. You are losing her without a monster's help.",
            "coinCost": 3,
            "flagSet": {
                  "refused_marriage": true
            }
      },
      "isHealing": false,
      "explorePriority": [
  ...
  "scene_23": {
    ...
    "initialFacts": {
      ...
      "established": [
        "Victor has been rescued by Walton's ship",
        "Victor is dying",
        "Victor has told his story",
        "the creature is on the ice",
        "Walton knows the truth"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      "collectibleItem": {
        "id": "sailor_spyglass",
        "label": "Sailor's Spyglass"
      },
      "badChoice": {
            "id": "send_eliizabeth_away",
            "label": "Send Elizabeth away for her safety",
            "consequence": "She goes, bewildered and afraid. You watch from the window. The creature is watching too — from the garden wall. It knows where she went.",
            "coinCost": 4,
            "flagSet": {
                  "sent_elizabeth_away": true
            }
      },
      "isHealing": false,
      "explorePriority": [
  ...
  "scene_24": {
    ...
    "sceneName": "The Creature's Lament",
        "presentCharacters": ["victor frankenstein","captain walton"],
    ...
    "initialFacts": {
      ...
      "established": [
        "Victor is dead",
        "the creature has appeared over Victor's body",
        "the creature is grieving",
        "the creature plans to end its own life on a funeral pyre",
        "the creature has left the ship heading north",
        "Walton has heard the full story"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      "collectibleItem": {
        "id": "final_letter",
        "label": "Elizabeth's Letter"
      },
      "badChoice": {
            "id": "stop_pursuing",
            "label": "Stop pursuing the creature and accept what happened",
            "consequence": "You sink to your knees in the snow. The creature pauses, looks back. For a moment, something like regret crosses its face. Then it is gone. You are alone with your guilt.",
            "coinCost": 3,
            "flagSet": {
                  "gave_up_pursuit": true
            }
      },
      "isHealing": false,
      "explorePriority": [
