module.exports = {
  "scene_10": {
    ...
    "sceneName": "The Stone Age",
        "presentCharacters": ["watson","laura_lyons"],
    ...
    "initialFacts": {
      ...
      "established": [
        "Holmes has been hiding on the moor in disguise",
        "Holmes has been watching Stapleton",
        "Stapleton goes to the Grimpen Mire every evening",
        "Stapleton has a large dog",
        "Holmes found by Watson at Bronze Age hut"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "reveal_holmes_location",
            "label": "Tell Laura Lyons where Holmes is hiding",
            "consequence": "Laura mentions it to Stapleton. That night, a figure creeps toward the stone hut on the tor. Holmes has to move — and the net closes faster.",
            "coinCost": 4,
            "flagSet": {
                  "exposed_holmes": true
            }
  ...
  "scene_11": {
    ...
    "sceneName": "Holmes Revealed",
        "presentCharacters": ["watson","holmes"],
    ...
    "initialFacts": {
      ...
      "established": [
        "Beryl Stapleton is Stapleton's wife, not sister",
        "Stapleton is likely a Baskerville heir",
        "Stapleton has a large dog hidden in the Mire",
        "Holmes suspects Stapleton lured Sir Charles through Laura Lyons",
        "Stapleton goes to the Mire every evening"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "surprise_at_holmes",
            "label": "Express shock that Holmes was hiding on the moor",
            "consequence": "\"You didn't trust me with the plan,\" you say, stung. Holmes looks at you with something close to apology. \"I needed your reactions to be genuine, Watson.\"",
            "coinCost": 3,
            "flagSet": {
                  "felt_betrayed": true
            }
  ...
  "scene_12": {
    ...
    "initialFacts": {
      ...
      "established": [
        "the Grimpen Mire is a deadly bog",
        "Holmes has marked safe paths with cairns",
        "enormous paw prints lead into the Mire",
        "a kennel is hidden in the Mire",
        "phosphorus smell near the Mire",
        "a pony was swallowed by the bog"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "demand_arrest_now",
            "label": "Demand Stapleton be arrested immediately",
            "consequence": "\"On what evidence?\" Holmes asks. \"A legend and a coincidence?\" You push. Holmes pushes back. If you arrest Stapleton now, he walks free by morning.",
            "coinCost": 3,
            "flagSet": {
                  "premature_arrest": true
            }
      },
      "isHealing": false,
      "explorePriority": [
  ...
  "scene_13": {
    ...
    "sceneName": "Laura Lyons",
        "presentCharacters": ["holmes","watson","sir_henry","stapleton"],
    ...
    "initialFacts": {
      ...
      "established": [
        "Laura Lyons wrote to Sir Charles on the night he died",
        "Stapleton used Laura to lure Sir Charles to the gate",
        "Stapleton promised Laura marriage but never intended it",
        "Laura was not at the meeting — she stayed home",
        "Stapleton told Laura to keep silent about the letter"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      "collectibleItem": {
        "id": "bloodhound_ink",
        "label": "Bloodhound Ink Print"
      },
      "badChoice": {
            "id": "let_sir_henry_walk_alone",
            "label": "Let Sir Henry walk home across the moor alone",
            "consequence": "The fog thickens. From somewhere in the dark, a howl rises — not a dog, not a wolf. Something else. Sir Henry quickens his pace. The ground trembles.",
            "coinCost": 4,
            "flagSet": {
                  "abandoned_henry": true
            }
      },
      "isHealing": false,
      "explorePriority": [
  ...
  "scene_14": {
    ...
    "initialFacts": {
      ...
      "established": [
        "Stapleton is a Baskerville heir — descended from Rodger Baskerville",
        "Stapleton is murdering the main line to claim the estate",
        "the portrait proves the family connection",
        "Holmes plans to set a trap using Sir Henry as bait"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "fire_too_early",
            "label": "Fire your revolver before the hound is fully revealed",
            "consequence": "The bullet whistles into the fog. The hound flinches but does not fall. It turns toward you now, eyes glowing, jaws dripping. You have one shot left.",
            "coinCost": 4,
            "flagSet": {
                  "missed_shot": true
            }
