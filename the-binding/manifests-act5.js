module.exports = {
  "scene_20": {
    ...
    "sceneName": "The Chase Begins",
        "presentCharacters": ["mina","van_helsing","seward","godalming"],
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "search_alone",
            "label": "Search Carfax Abbey alone at night",
            "consequence": "The abbey is a ruin of broken pews and rotting wood. In the crypt below, you hear chanting. Shadows move. You flee, but something follows you home.",
            "coinCost": 4,
            "flagSet": {
                  "abbey_shadow": true
            }
  ...
  "scene_21": {
    ...
    "sceneName": "The Carpathian Mountains",
        "presentCharacters": ["mina","van_helsing","dracula"],
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "open_crypt_door",
            "label": "Force open the sealed crypt door",
            "consequence": "The door groans and falls inward. Dust and the stench of centuries pour out. In the darkness, dozens of eyes open. You run, slamming doors behind you.",
            "coinCost": 5,
            "flagSet": {
                  "breached_crypt": true
            }
  ...
  "scene_22": {
    ...
    "sceneName": "The Castle Revisited",
        "presentCharacters": ["van_helsing","mina","godalming"],
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "argue_with_helsing",
            "label": "Argue with Van Helsing about the plan",
            "consequence": "Minutes lost in bickering. When you finally agree, the sun has set. Dracula's ship has already docked. The advantage is gone.",
            "coinCost": 3,
            "flagSet": {
                  "wasted_time": true
            }
  ...
  "scene_23": {
    ...
    "sceneName": "The Three Sisters — Final Battle",
        "presentCharacters": ["mina","jonathan harker","van_helsing","dracula"],
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "look_back",
            "label": "Look back as you flee the castle",
            "consequence": "You turn. Dracula stands at the gate, watching. His cloak billows in a wind that touches nothing else. He raises one hand — not in threat, but farewell. You will see him again.",
            "coinCost": 3,
            "flagSet": {
                  "looked_back": true
            }
  ...
  "scene_24": {
    ...
    "sceneName": "Dracula's End",
        "presentCharacters": ["mina","jonathan harker","van_helsing","seward","dracula"],
    "isFinal": true,
    ...
    "storyMode": {
      ...
      "badChoice": {
            "id": "drop_the_knife",
            "label": "Drop the consecrated knife in the final moment",
            "consequence": "The blade clatters on stone. Dracula's eyes widen — not with triumph, but surprise. In that instant of hesitation, the dawn breaks. But the cost was nearly everything.",
            "coinCost": 4,
            "flagSet": {
                  "dropped_weapon": true
            }
