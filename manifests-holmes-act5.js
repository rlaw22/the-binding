module.exports = {
  "scene_20": {
    ...
    "initialFacts": {
      ...
      "established": [
        "Stapleton fell into the Grimpen Mire",
        "the Mire has swallowed him",
        "Stapleton carried forged identity documents",
  ...
  "scene_21": {
    ...
    "initialFacts": {
      ...
      "established": [
        "Stapleton was Rodger Baskerville's grandson",
        "he changed his name and moved to Dartmoor",
        "the hound was bred from a fighting mastiff",
        "phosphorus paste was Stapleton's invention",
        "Sir Charles died of fright",
        "Sir Henry will inherit and live at the Hall"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "isHealing": false,
      "explorePriority": [
        "ask_about_stapleton_past",
        "ask_about_hound_breeding",
        "ask_about_sir_charles_death"
      ]
    }
  },
  "scene_22": {
    ...
    "initialFacts": {
      ...
      "established": [
        "Beryl was Stapleton's wife, forced to play his sister",
        "she tried to warn Sir Henry and was punished",
        "she wants to go to her sister in Edinburgh",
        "Holmes will arrange her passage and funds",
        "Beryl is free"
      ]
    },
    "locationKeywords": {
  ...
  "scene_23": {
    ...
    "initialFacts": {
      ...
      "established": [
        ...
        "Stapleton's death recorded as accidental",
        "Sir Henry is safe",
        "Beryl is on her way to Edinburgh"
      ]
    },
    "locationKeywords": {
      "banned": [
  ...
  "scene_24": {
    ...
    "initialFacts": {
      ...
      "established": [
        ...
        "Holmes reflects on curses and obsession",
        "the moor is quiet now",
