module.exports = {
  "scene_05": {
    ...
    "storyMode": {
      ...
      "badChoice": {
        "id": "trust_stranger",
        "label": "Risk taking action: Examine the soil-filled tombs",
  ...
  "scene_06": {
    ...
    "storyMode": {
      ...
      "badChoice": {
        "id": "explore_alone",
        "label": "Risk taking action: Press the crucifix toward the nearest sister",
  ...
  "scene_07": {
    ...
    "storyMode": {
      ...
      "badChoice": {
        "id": "drink_offered",
        "label": "Risk taking action: Study the section on vampire weaknesses",
  ...
  "scene_08": {
    ...
    "storyMode": {
      ...
      "badChoice": {
        "id": "open_coffin",
        "label": "Risk taking action: Climb down the castle wall",
  ...
  "scene_09": {
    ...
    "storyMode": {
      ...
      "badChoice": {
        "id": "ignore_warnings",
        "label": "Risk taking action: Walk toward the monastery gate",
