module.exports = {
  "scene_15": {
    ...
    "initialFacts": {
      ...
      "established": [
        "Holmes has devised an ambush plan",
        "Sir Henry will walk the moor alone as bait",
        "Lestrade from Scotland Yard has arrived",
    ...
    "storyMode": {
      ...
      "badChoice": {
        "id": "dismiss_witness",
        "label": "Risk taking action: Study the map of the moor and the planned ambush positions",
  ...
  "scene_16": {
    ...
    "initialFacts": {
      ...
      "established": [
        "the hound has appeared on the moor",
        "it is enormous and coated in phosphorus",
        "it is pursuing Sir Henry",
        "the hound looks supernatural but is a real animal",
        "Holmes, Watson, and Lestrade are in ambush positions"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "badChoice": {
        "id": "reveal_clue",
        "label": "Risk taking action: Watch the hound as it emerges from the mist",
  ...
  "scene_17": {
    ...
    "initialFacts": {
      ...
      "established": [
        "the hound has been hit but keeps coming",
        "Watson has fired and wounded it",
        "the chase is across open moor",
        "the hound is gaining on Sir Henry",
        "Holmes is closing in"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "badChoice": {
        "id": "ignore_watson",
        "label": "Risk taking action: Fire your revolver at the hound",
  ...
  "scene_18": {
    ...
    "initialFacts": {
      ...
      "established": [
        "the hound is dead — a real mastiff coated in phosphorus",
        "Holmes killed it with a single shot",
        "Sir Henry is alive and unharmed",
        "Stapleton bred and prepared the hound",
        "Stapleton has likely fled toward the Mire"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "badChoice": {
        "id": "take_bribe",
        "label": "Risk taking action: Examine the dead hound closely",
  ...
  "scene_19": {
    ...
    "initialFacts": {
      ...
      "established": [
        "found Stapleton's lair in the Mire",
        "breeding records prove the hound was trained to kill",
        "Beryl Stapleton was tied up and starved",
        "the original hound's remains were found",
        "Stapleton has been planning for three years"
      ]
    },
    "locationKeywords": {
      "banned": [
    ...
    "storyMode": {
      ...
      "badChoice": {
        "id": "rush_in",
        "label": "Risk taking action: Follow the voice deeper into the Mire",
